                        ...
                        if element_.tag == 'way':
                            for tag_ in element_.findall('tag'):
                                if tag_.attrib['v'] == 'passage':
                                    ...
                                    passage_degree=element_.find("tag[@k='degree']").get('v')
                                    # Jiajie: passage_type -> osmAG:passage_type
                                    passage_type=element_.find("tag[@k='passage_type']").get('v')
